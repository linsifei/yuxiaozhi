          ...
          <div id="logistics-card" className="bg-[#161618] border border-[#2A2A2C] rounded-xl p-6 tonal-elevation">
            <div className="flex justify-between items-start mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-mono text-[10px] text-[#666] tracking-wider uppercase">订单号 #YX-88291</p>
                  <p className="font-headline text-xl text-[#E0E0E0] font-medium transition-colors hover:text-[#4CAF50]">优质龟背竹</p>
                </div>
              </div>
              <div className="bg-[#1A1A1C] border border-[#2D5A27]/30 text-[#4CAF50] px-3 py-1 rounded text-[10px] font-bold uppercase tracking-widest">在途 In Transit</div>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#161618] border border-[#2A2A2C] rounded-xl p-6 shadow-sm group">
            <div className="flex justify-between items-start mb-6">
              <div className="w-12 h-12 bg-[#2D5A27]/20 border border-[#2D5A27]/30 rounded-full flex items-center justify-center text-[#4CAF50] group-hover:bg-[#2D5A27]/40 transition-colors">
                <span className="material-symbols-outlined">construction</span>
              </div>
              <div className="text-right">
                <p className="font-mono text-[9px] text-[#666] uppercase tracking-tighter">PARTNER</p>
                <p className="font-bold text-xs uppercase tracking-wider text-[#888]">啄木鸟与森林</p>
              </div>
            </div>
            ...
            <div className="mt-auto pt-4 border-t border-[#2A2A2C] flex flex-col gap-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-xs text-[#E0E0E0]">10.25 <span className="text-[#444]">FRI</span></span>
                </div>
                <span className="bg-[#2D5A27]/20 text-[#4CAF50] px-2 py-0.5 rounded text-[9px] font-bold uppercase border border-[#2D5A27]/20">CONFIRMED</span>
              </div>
              <button className="w-full py-2.5 bg-[#0A0A0B] border border-[#2A2A2C] text-[#E0E0E0] text-xs font-bold uppercase tracking-widest rounded hover:bg-[#1A1A1C] transition-colors">管理预约计划</button>
            </div>
          </div>
          ...
          <div className="bg-[#161618] border border-[#2A2A2C] rounded-xl p-6 shadow-sm">
            <div className="flex justify-between items-start mb-6">
              <div className="w-12 h-12 bg-[#1A1A1C] border border-[#2A2A2C] rounded-full flex items-center justify-center text-[#666]">
                <span className="material-symbols-outlined">cleaning_services</span>
              </div>
              <div className="text-right">
                <p className="font-mono text-[9px] text-[#666] uppercase tracking-tighter">PARTNER</p>
                <p className="font-bold text-xs uppercase tracking-wider text-[#888]">美团智家服务</p>
              </div>
            </div>
            ...
            <div className="mt-auto pt-4 border-t border-[#2A2A2C] flex flex-col gap-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="material-symbols-outlined text-[#666] text-xs">schedule</span>
                  <span className="font-mono text-xs text-[#666]">正在匹配专员...</span>
                </div>
              </div>
              <button className="w-full py-2.5 bg-[#0A0A0B] border border-[#2A2A2C] text-[#E0E0E0] text-xs font-bold uppercase tracking-widest rounded transition-colors opacity-50 cursor-not-allowed">等待派单</button>
            </div>
          </div>
          ...
          <div className="bg-[#2D5A27] text-white rounded-xl p-6 shadow-xl relative overflow-hidden group">
            ...
            <div className="mt-auto relative z-10 flex flex-col gap-5">
              ...
              <button className="w-full py-3 bg-white text-[#2D5A27] font-bold text-xs uppercase tracking-[0.2em] rounded active:scale-95 transition-transform shadow-lg">立即连线专家</button>
            </div>
          </div>
        </div>
      </section>
